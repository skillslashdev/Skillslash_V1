...
const BlogFirstSection = dynamic(() =>
  import("../../components/Blog/BlogHeader/BlogFirstSection")
);
const BlogHeadBox1 = dynamic(() =>
  import("../../components/Blog/BlogHeadBox1")
);
const AllBlogs = dynamic(() => import("../../components/Blog/AllBlogs"));
...
const Quote = dynamic(() => import("../../components/Blog/Quote"));
